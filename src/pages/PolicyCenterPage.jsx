...
const PRIVACY_POLICY_ITEMS = [
    ...
    content: (
      <>
        ...
        <ul className="list-disc space-y-2 pl-6 leading-7 text-base-content/80">
          <li><strong className="text-base-content">Identity Data:</strong> Name and username.</li>
          <li><strong className="text-base-content">Contact Data:</strong> Email, phone number, and shipping address.</li>
          <li>
            <strong className="text-base-content">Transaction Data:</strong> Details about the products you have bought
            (but never your full credit card number. Our secure payment processors handle that).
          </li>
          <li>
            <strong className="text-base-content">Technical Data:</strong> Your IP address and device type to make sure
            our mobile site looks &quot;GG&quot; on your specific phone.
          </li>
        </ul>
      </>
    ),
  ...
  {
    id: "privacy-3",
    title: "3. No Selling to Third Parties",
    content: (
      <p className="leading-7 text-base-content/80">
        We do not sell your personal data. We are not in the business of selling your email to random advertisers. We only
        share info with partners necessary to run the shop (like the courier delivering your package or our secure payment
        gateway).
      </p>
    ),
  },
  {
    ...
    content: (
      <p className="leading-7 text-base-content/80">
        We use cookies to remember what is in your Cart and to keep you logged in. You can &quot;disable&quot; cookies in
        your browser settings, but the site might feel a bit &quot;laggy&quot; or forget your items.
      </p>
    ),
  },
  {
    id: "privacy-5",
    title: "5. Your Rights (The &quot;Admin&quot; Controls)",
    content: (
      <>
        <p className="leading-7 text-base-content/80">You have control over your data. At any time, you can:</p>
        <ul className="list-disc space-y-2 pl-6 leading-7 text-base-content/80">
          <li><strong className="text-base-content">Access:</strong> Ask for a copy of the data we have on you.</li>
          <li>
            <strong className="text-base-content">Delete:</strong> Request that we &quot;delete your character&quot;
            (wipe your account data).
          </li>
          <li><strong className="text-base-content">Unsubscribe:</strong> Opt-out of marketing emails with one click.</li>
        </ul>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p className="leading-7 text-base-content/80">
          We use &quot;End-to-End&quot; encryption (SSL) to protect your data during checkout. Our servers are guarded by
          industry-standard firewalls to keep &quot;invaders&quot; out.
        </p>
        <p className="leading-7 text-base-content/80">
          Privacy questions:{" "}
...
const TERMS_OF_USE_ITEMS = [
  {
    ...
    content: (
      <>
        <p className="leading-7 text-base-content/80">To buy certain loot, you might need to create an account.</p>
        <ul className="list-disc space-y-2 pl-6 leading-7 text-base-content/80">
  ...
  {
    id: "terms-2",
    title: "2. Fair Play (Anti-Bot Policy)",
    content: (
      <>
        <p className="leading-7 text-base-content/80">We want a fair experience for all gamers.</p>
        <ul className="list-disc space-y-2 pl-6 leading-7 text-base-content/80">
          <li>
            The use of automated scripts, bots, or scrapers to purchase limited-edition items is strictly prohibited.
          </li>
          <li>
  ...
  {
    id: "terms-3",
    title: "3. Product Pricing & Errors",
    content: (
      <>
        <p className="leading-7 text-base-content/80">We try to be 100% accurate, but sometimes &quot;glitches&quot; happen.</p>
        <ul className="list-disc space-y-2 pl-6 leading-7 text-base-content/80">
          <li>
            If an item is listed at an incorrect price due to a typo or system error, we have the right to cancel the order
            and refund you.
          </li>
  ...
  },
  {
    ...
    content: (
      <>
        <p className="leading-7 text-base-content/80">
          Everything you see here, the logos, the &quot;Funzies&quot; name, the code, and the custom graphics, belongs to
          us or our partners.
        </p>
        <p className="leading-7 text-base-content/80">
    ...
    content: (
      <>
        ...
        <ul className="list-disc space-y-2 pl-6 leading-7 text-base-content/80">
          ...
          <li>
            Once a digital code is &quot;revealed&quot; or sent, it is generally non-refundable (see our Refund Policy for
            details).
          </li>
        </ul>
      </>
  ...
  },
  {
    ...
    content: (
      <>
        <p className="leading-7 text-base-content/80">If you post a review or upload a photo of your setup:</p>
        <ul className="list-disc space-y-2 pl-6 leading-7 text-base-content/80">
...
export default function PolicyCenterPage() {
  ...
  const pageTitle = isTermsRoute ? "Terms of Use" : "Privacy Policy";
  const pageDescription = isTermsRoute
